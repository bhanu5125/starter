...
export default function UserTable() {
  ...
  useEffect(() => {
    axios.get("https://tcs.trafficcounting.in/nodejs/api/get-users")
      .then((response) => {
  ...
  const handleEditClick = async (UserId, username) => {
    try {
      ...
      const response = await axios.post("https://tcs.trafficcounting.in/nodejs/api/generate-token", { UserId });
