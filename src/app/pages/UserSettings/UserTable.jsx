...
export default function UserTable() {
  ...
  useEffect(() => {
    axios.get("http://vps65389.dreamhostps.com:5000/api/get-users")
      .then((response) => {
  ...
  const handleEditClick = async (UserId, username) => {
    try {
      ...
      const response = await axios.post("http://vps65389.dreamhostps.com:5000/api/generate-token", { UserId });
