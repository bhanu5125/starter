...
export default function EmployeesDatatable() {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get("https://tcs.trafficcounting.in/nodejs/api/get-salary");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.put("https://tcs.trafficcounting.in/nodejs/api/update-salaries", payload);
  
      if (response.data.success) {
        // Refresh data after a successful update
        const refreshed = await axios.get("https://tcs.trafficcounting.in/nodejs/api/get-salary");
